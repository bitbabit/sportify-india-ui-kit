  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4">
        ...
        {/* Navigation - Desktop */}
        <nav className="hidden lg:flex items-center justify-between gap-8 pb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Cart with total */}
            <Link to="/cart" className="flex items-center gap-2 hover:bg-accent/10 px-2 py-1.5 rounded-lg transition-colors group">
              <div className="relative">
                <ShoppingCart className="h-5 w-5 group-hover:scale-110 transition-transform duration-300" />
                <span className="absolute -top-1 -right-1 h-4 w-4 bg-secondary text-secondary-foreground rounded-full text-[10px] flex items-center justify-center font-bold">
                  5
                </span>
              </div>
